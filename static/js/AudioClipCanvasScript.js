	...
	*/
	...
	drawAudioBufferToRectangle(rect,arr)
	{
		...
		from_y = 1-from_y; // flip y value so that it is right side up
   		this.ctx.moveTo(from_x+rect[0].x,rect[0].y+from_y*rectHeight); // path starts here
		let to_x = 0; // we declare here rather than in the loop for efficiency reasons
		let to_y = 0;
